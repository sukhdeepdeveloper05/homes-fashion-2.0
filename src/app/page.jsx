...
export default function Home() {
  return (
    <div className="bg-foreground grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start container">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          <Button variant="foreground" appearance="solid">
            <FiLoader className="h-5 w-5" aria-hidden="true" />
            Read our docs
          </Button>
        </div>
      </main>
